...
jQuery(document).ready(function(e) {
    (function($){
		...
		$('#commentform #author').attr('placeholder','Tu Nombre...');
		$('#commentform #email').attr('placeholder','Tu Email...');
		$('#commentform #url').attr('placeholder','Tu Web...');	
		$('#commentform input#submit').val('Enviar Comentario');
	}(jQuery));
});